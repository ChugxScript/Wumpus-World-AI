...
class Lose():
    ...
    def run(self, player_score):
        ...
        while True:
            ...
            self.display.blit(self.player_score_text, (500, 443))
            self.draw_rectangles()
            pygame.display.flip()
    ...
    def draw_rectangles(self):
        WHITE = (255,255 , 255)
        self.rectangles = [
            {"id": 1, "rect": pygame.Rect(105, 473, 397, 42)},
            {"id": 2, "rect": pygame.Rect(502, 473, 395, 42)}
        ]
        for rect in self.rectangles:
    ...
    def load_assets(self):
        ...
        self.gif_obj = gif.load(os.path.join(self.states_dir, "lose.gif"))